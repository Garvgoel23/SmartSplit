      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto px-6 flex flex-col items-start justify-between min-h-[250px]">
        ...
        <AnimatedContainer className="flex flex-col gap-6 max-w-sm">
          ...
          <div className="flex flex-col gap-3 mt-4">
            <p className="text-white/50 text-sm">
              Made by <span className="text-white font-medium"><a href="https://www.linkedin.com/in/parthsaarthie-sharma/" target="_blank" rel="noopener noreferrer" className="hover:text-[#b2f5d1] transition-colors">Parthsaarthie Sharma</a></span> and <span className="text-white font-medium"><a href="https://www.linkedin.com/in/garv-goel/" target="_blank" rel="noopener noreferrer" className="hover:text-[#b2f5d1] transition-colors">Garv Goel</a></span>
            </p>
            <div className="flex items-center gap-4 text-white/50 mt-2">
              <a href="https://github.com/Garvgoel23/SmartSplit" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors" aria-label="GitHub">
